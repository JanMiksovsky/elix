...
class DrawerWithGrip extends Drawer {
  ...
  set gripPartType(gripPartType) {
    ...
    console.warn(
      `Deprecation warning: The public gripPartType property is deprecated and will be removed. Create a subclass and set the gripPartType state member in defaultState instead.`
    );
